...
import MonitorCardImg from '../assets/monitorCardImg.png';
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mt-4 mb-6 md:w-4/5">
                        Lorem Ipsum Dolonr Incididun
                    </h2>

                    <p className="text-gray-600 mb-8">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do 
                        eiusmod tempor incididunt ut labore et dolore magna aliquat. Eiusmod 
                        tempor incididunt ut labore et dolore magna aliquat didunt ut labore et dolore.
                    </p>
