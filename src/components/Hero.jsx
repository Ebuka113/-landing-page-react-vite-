        ...
        <section id='home' className="container mx-auto flex flex-col md:flex-row justify-between pt-44 pb-6 px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-full md:w-1/2 space-y-8">
                    ...
                    transition-colors cursor-pointer group">
                        <span className="text-green-600 hover:text-blue-300 group-hover:scale-110 transition-transform">⭐</span>
                      ...
                      className="text-gray-600 text-lg md:text-xl max-w-xl">
                        ...
                        className="flex gap-3 max-w-md">
                            <input type="email"
                             ...
                             className="flex-1
                            px-6 py-4 border border-gray-200 rounded-xl focus:outline-none focus:border-blue-600
